...
function sourceWeight(source) {
    ...
    if (normalized.includes('reuters') || normalized.includes('bloomberg') || normalized.includes('wsj'))
        return 1;
    if (normalized.includes('finnhub') || normalized.includes('polygon'))
        return 0.75;
    return 0.5;
}
...
export function deriveNewsImpactExplanation(symbol, news) {
