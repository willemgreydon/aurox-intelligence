import { z } from 'zod';
import { brokerAssetScopeSchema, brokerModeSchema, chartTypeSchema, dashboardModuleIdSchema, dashboardPresetSchema, localeSchema, timePeriodSchema, } from '../workspace/preferences';
...
export function normalizeTrackedSymbolsInput(input) {
    const seen = new Set();
