---
name: aurox-correlation-engine
description: Implement cross-asset correlation inputs for concentration and portfolio-risk analysis.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-correlation-engine Skill
## Purpose
Implement cross-asset correlation inputs for concentration and portfolio-risk analysis.
## When To Use
- Add symbol/asset-class correlation checks for overlay decisions.
...
2. Inspect domain logic in focused packages: packages/agents/src/risk; apps/web/server/services; packages/db queries.
...
- Document sampling window and method; keep correlation calculation deterministic.
...
## Safety Rules
- If history is insufficient, disable correlation penalty with explicit warning.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: packages/agents/src/risk; apps/web/server/services; packages/db queries
## Expected Output Format
`	ext
Skill: aurox-correlation-engine
Scope:
- ...
Contracts/Types:
- created/updated ...
