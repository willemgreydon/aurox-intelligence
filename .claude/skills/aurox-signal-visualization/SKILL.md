---
name: aurox-signal-visualization
description: Implement signal score visualization patterns across cards, rows, and detail pages.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-signal-visualization Skill
## Purpose
Implement signal score visualization patterns across cards, rows, and detail pages.
## When To Use
- Add badges, score trends, confidence indicators, and explanatory tooltips.
- Changes span query -> mapper -> service -> route -> UI and require architecture-safe delivery.
## When Not To Use
- Execution policy editing.
...
2. Inspect domain logic in focused packages: apps/web/components/signals; apps/web/components/invest; apps/web/components/charts.
...
- Render score, label, confidence, explanation, and indicator contributors.
...
## Safety Rules
- If signal unavailable, render explicit unavailable state, not synthetic certainty.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: apps/web/components/signals; apps/web/components/invest; apps/web/components/charts
## Expected Output Format
`	ext
Skill: aurox-signal-visualization
Scope:
- ...
Contracts/Types:
- created/updated ...
