---
name: aurox-risk-visualization
description: Build risk overlays and warnings that are dense but readable for workstation users.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-risk-visualization Skill
## Purpose
Build risk overlays and warnings that are dense but readable for workstation users.
## When To Use
- Implement risk-level visuals, warnings, and concentration/exposure indicators.
...
2. Inspect domain logic in focused packages: apps/web/components/invest/trade-risk-overlay.tsx; apps/web/app/invest/portfolio.
...
- Use progressive disclosure; highlight blocking vs advisory warnings clearly.
...
## Safety Rules
- Risk visuals should never indicate live approval by default.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: apps/web/components/invest/trade-risk-overlay.tsx; apps/web/app/invest/portfolio
## Expected Output Format
`	ext
Skill: aurox-risk-visualization
Scope:
- ...
Contracts/Types:
- created/updated ...
