---
name: aurox-risk-overlay
description: Build reusable trade-risk overlay view models and UI panels.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-risk-overlay Skill
## Purpose
Build reusable trade-risk overlay view models and UI panels.
## When To Use
- Expose stop suggestions, concentration warnings, and exposure impacts in UI.
- Changes span query -> mapper -> service -> route -> UI and require architecture-safe delivery.
## When Not To Use
- Raw execution adapter changes.
...
2. Inspect domain logic in focused packages: apps/web/components/invest/trade-risk-overlay.tsx; apps/web/server/services; packages/agents/src/risk.
...
- Surface max position, volatility, drawdown, liquidity, stop-loss, concentration warnings.
...
## Safety Rules
- Overlay must never imply live readiness by itself.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: apps/web/components/invest/trade-risk-overlay.tsx; apps/web/server/services; packages/agents/src/risk
## Expected Output Format
`	ext
Skill: aurox-risk-overlay
Scope:
- ...
Contracts/Types:
- created/updated ...
