---
name: aurox-liquidity-check
description: Implement liquidity and spread checks before trade approval.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-liquidity-check Skill
## Purpose
Implement liquidity and spread checks before trade approval.
## When To Use
- Add liquidity constraints to risk and execution policies.
- Changes span query -> mapper -> service -> route -> UI and require architecture-safe delivery.
## When Not To Use
- Theme or CSS-only updates.
...
2. Inspect domain logic in focused packages: packages/agents/src/risk; apps/web/server/services.
...
- Emit explicit liquidity warning severity and approval impact.
...
## Safety Rules
- Insufficient liquidity should downgrade or block order intent.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: packages/agents/src/risk; apps/web/server/services
## Expected Output Format
`	ext
Skill: aurox-liquidity-check
Scope:
- ...
Contracts/Types:
- created/updated ...
