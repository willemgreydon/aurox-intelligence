---
name: aurox-portfolio-ui
description: Design portfolio screens and controls around simulation-safe decision loops.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-portfolio-ui Skill
## Purpose
Design portfolio screens and controls around simulation-safe decision loops.
## When To Use
- Implement open-position tables, PnL columns, and simulation close/review actions.
- Changes span query -> mapper -> service -> route -> UI and require architecture-safe delivery.
## When Not To Use
- Non-portfolio backend tasks.
...
2. Inspect domain logic in focused packages: apps/web/app/portfolio; apps/web/app/invest/portfolio; apps/web/components/invest.
...
- Show symbol, class, qty, entry, current, PnL, exposure, risk, signal, openedAt, actions.
...
## Safety Rules
- Empty states must reinforce simulation-first behavior and safe navigation.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: apps/web/app/portfolio; apps/web/app/invest/portfolio; apps/web/components/invest
## Expected Output Format
`	ext
Skill: aurox-portfolio-ui
Scope:
- ...
Contracts/Types:
- created/updated ...
