---
name: aurox-market-sentiment
description: Integrate structured sentiment signals into explainable intelligence outputs.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-market-sentiment Skill
## Purpose
Integrate structured sentiment signals into explainable intelligence outputs.
## When To Use
- Add sentiment features and summarize their recommendation impact.
- Changes span query -> mapper -> service -> route -> UI and require architecture-safe delivery.
## When Not To Use
- Pure order-router changes.
...
2. Inspect domain logic in focused packages: packages/signals/src/features/sentiment-features.ts; packages/api-contracts/src/intelligence.
...
- Sentiment is additive context, never sole decision driver.
...
## Safety Rules
- If sentiment data is unavailable, degrade confidence and continue deterministically.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: packages/signals/src/features/sentiment-features.ts; packages/api-contracts/src/intelligence
## Expected Output Format
`	ext
Skill: aurox-market-sentiment
Scope:
- ...
Contracts/Types:
- created/updated ...
