---
name: aurox-reporting-engine
description: Generate deterministic portfolio/execution/risk reports for internal operators.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-reporting-engine Skill
## Purpose
Generate deterministic portfolio/execution/risk reports for internal operators.
## When To Use
- Build reporting summaries, periodic snapshots, and audit exports.
- Changes span query -> mapper -> service -> route -> UI and require architecture-safe delivery.
## When Not To Use
- Single card CSS edits.
...
2. Inspect domain logic in focused packages: docs/reporting-framework.md; packages/db queries; apps/web/server/services.
...
- Reports must include timeframe, source, freshness, and calculation assumptions.
...
## Safety Rules
- Never present simulated metrics as live performance.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: docs/reporting-framework.md; packages/db queries; apps/web/server/services
## Expected Output Format
`	ext
Skill: aurox-reporting-engine
Scope:
- ...
Contracts/Types:
- created/updated ...
