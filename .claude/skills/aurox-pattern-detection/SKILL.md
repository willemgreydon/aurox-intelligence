---
name: aurox-pattern-detection
description: Build deterministic pattern detection features from historical market series.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-pattern-detection Skill
## Purpose
Build deterministic pattern detection features from historical market series.
## When To Use
- Add trend/breakout/reversal pattern modules for intelligence layers.
...
2. Inspect domain logic in focused packages: packages/signals; packages/forecasting; apps/web/server/services.
...
- Pattern definitions require finite windows and explicit confidence metrics.
...
## Safety Rules
- Pattern confidence must not bypass risk and policy checks.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: packages/signals; packages/forecasting; apps/web/server/services
## Expected Output Format
`	ext
Skill: aurox-pattern-detection
Scope:
- ...
Contracts/Types:
- created/updated ...
