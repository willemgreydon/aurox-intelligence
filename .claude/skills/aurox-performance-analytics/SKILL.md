---
name: aurox-performance-analytics
description: Implement performance analytics across returns, drawdowns, and benchmark-relative outcomes.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-performance-analytics Skill
## Purpose
Implement performance analytics across returns, drawdowns, and benchmark-relative outcomes.
## When To Use
- Add Sharpe-like metrics, cumulative return panels, or benchmark splits.
...
2. Inspect domain logic in focused packages: apps/web/components/charts; apps/web/server/services/portfolio-service.ts; packages/db.
...
- Use deterministic formulas and clearly label benchmark source.
...
## Safety Rules
- Flag insufficient history and avoid overconfident metrics.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: apps/web/components/charts; apps/web/server/services/portfolio-service.ts; packages/db
## Expected Output Format
`	ext
Skill: aurox-performance-analytics
Scope:
- ...
Contracts/Types:
- created/updated ...
