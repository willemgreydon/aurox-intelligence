---
name: aurox-slippage-model
description: Model expected slippage and enforce tolerance bounds in execution prep.
allowed-tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
---
# aurox-slippage-model Skill
## Purpose
Model expected slippage and enforce tolerance bounds in execution prep.
## When To Use
- Add slippage estimation and max tolerance policy checks.
...
2. Inspect domain logic in focused packages: packages/agents/src/risk; packages/agents/src/workflows; apps/web/server/services/trade-execution-service.ts.
...
- Use deterministic slippage assumptions from volatility/liquidity inputs.
...
## Safety Rules
- If slippage estimate exceeds tolerance, block execution path.
...
- pps/web/app
- pps/web/components
- Skill-specific focus: packages/agents/src/risk; packages/agents/src/workflows; apps/web/server/services/trade-execution-service.ts
## Expected Output Format
`	ext
Skill: aurox-slippage-model
Scope:
- ...
Contracts/Types:
- created/updated ...
