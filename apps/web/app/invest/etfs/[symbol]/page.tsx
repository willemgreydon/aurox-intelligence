          ...
          <div className="analytics-side-stack">
            <Card className="analytics-card">
              ...
              <div className="analytics-card__action-grid">
                ...
                />
                <SimulatedOrderForm assetId={asset.asset.assetId} symbol={asset.asset.symbol} assetClass="etf" side="buy" strategyLaneId="manual_multi_asset_lane" simulationSessionId={sessionContext?.sessionId ?? undefined} label={messages.dashboard.buySimulated} showQuantityInput quantityLabel={messages.simulation.quantity} disabled={tradingDisabled} disabledReason={disabledReason} currentPrice={asset.quote?.price ?? null} currentHeldQuantity={asset.position?.quantity ?? 0} sourceContext="etf-lane" uiText={{ quantityMode: messages.simulation.quantity, notionalMode: 'Notional', notionalAmount: 'Notional amount', quantityRequired: messages.simulation.validation.quantityRequired, minimumShare: messages.simulation.validation.minimumShare, minimumUnit: messages.simulation.validation.minimumUnit, minimumQuantity: (value) => messages.simulation.validation.minimumQuantity.replace('{{value}}', String(value)), wholeSharesOnly: messages.simulation.validation.wholeSharesOnly, quantityStepMismatch: (step) => messages.simulation.validation.quantityStepMismatch.replace('{{step}}', String(step)), minimumNotional: messages.simulation.validation.minimumNotional, noOpenPositionToSell: (s) => messages.simulation.validation.noOpenPositionToSell.replace('{{symbol}}', s), closePosition: messages.simulation.chips.closePosition }} />
                <SimulatedOrderForm assetId={asset.asset.assetId} symbol={asset.asset.symbol} assetClass="etf" side="sell" strategyLaneId="manual_multi_asset_lane" simulationSessionId={sessionContext?.sessionId ?? undefined} label={messages.dashboard.sellSimulated} showQuantityInput quantityLabel={messages.simulation.quantity} disabled={tradingDisabled || !asset.position || asset.position.quantity <= 0} disabledReason={!asset.position || asset.position.quantity <= 0 ? messages.simulation.validation.noOpenPositionToSell.replace('{{symbol}}', asset.asset.symbol) : disabledReason} currentPrice={asset.quote?.price ?? null} currentHeldQuantity={asset.position?.quantity ?? 0} sourceContext="etf-lane" uiText={{ quantityMode: messages.simulation.quantity, notionalMode: 'Notional', notionalAmount: 'Notional amount', quantityRequired: messages.simulation.validation.quantityRequired, minimumShare: messages.simulation.validation.minimumShare, minimumUnit: messages.simulation.validation.minimumUnit, minimumQuantity: (value) => messages.simulation.validation.minimumQuantity.replace('{{value}}', String(value)), wholeSharesOnly: messages.simulation.validation.wholeSharesOnly, quantityStepMismatch: (step) => messages.simulation.validation.quantityStepMismatch.replace('{{step}}', String(step)), minimumNotional: messages.simulation.validation.minimumNotional, noOpenPositionToSell: (s) => messages.simulation.validation.noOpenPositionToSell.replace('{{symbol}}', s), closePosition: messages.simulation.chips.closePosition }} />
              </div>
            </Card>
            <DetailSlotCard
              eyebrow="ETF profile"
